...
var fieldTags = [
    ...
    {tag:"CIN", name:"Comment In"},
    {tag:"CON", name:"Comment On"},
    {tag:"CP", name:"Chapter"},
    ...
    {tag:"CRF", name:"Corrected and republished from"},
    {tag:"CRI", name:"Corrected and republished in"},
    {tag:"CTDT", name:"Contribution Date"},
    {tag:"CRDT", name:"Create Date"},
    {tag:"DRDT", name:"Date Revised"},
    ...
    {tag:"EFR", name:"Erratum For"},
    {tag:"EIN", name:"Erratum In"},
    {tag:"EN", name:"Edition"},
    {tag:"ED", name:"Editor"},
    ...
    {tag:"JID", name:"NLM Unique ID"},
    {tag:"RF", name:"Number of References"},
    {tag:"OAB", name:"Other Abstract"},
    {tag:"OABL", name:"Other Abstract Language"},
    ...
    {tag:"RIN", name:"Retraction In"},
    {tag:"ROF", name:"Retraction Of"},
