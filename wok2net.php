...
<?php include('includes/header.php') ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="span12">
                    <h2>WoK to Network</h2>
                    <p class="text-info">
                        Extract a network from a <em>Web of Knowledge</em> file and download it. You may visualize it with <a href="http://gephi.org">Gephi</a>.
                    </p>
                    <hr/>
                </div>
            </div>
            <div class="row">
                <div class="span4">
                    <div id="uploadDiv">
                        <h4>Upload your Web of Knowledge CSV file</h4>
        ...
        <script src="js/page_wok2net.js"></script>
